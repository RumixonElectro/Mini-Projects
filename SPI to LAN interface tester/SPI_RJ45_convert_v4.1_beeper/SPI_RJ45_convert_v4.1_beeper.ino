...
void setup() {
  ...
  // Call Ethernet.begin with a strict 10-second timeout parameter (10000 ms) 
  // and a 2-second response timeout to prevent the default 60-second blocking hang.
  if (Ethernet.begin(mac, 10000, 2000) == 0) {
    ...
    // No IP -> Continuous 100ms beep / 100ms gap loop
    while (true) {
